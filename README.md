...
- [cpp-mmf]([GitHub - carlomilanesi/cpp-mmf: C++98 library that encapsulates memory-mapped-files for POSIX or Windows](https://github.com/carlomilanesi/cpp-mmf/)) - 对 POSIX 或 Windows 封装映射到内存文件的 C++98 库
